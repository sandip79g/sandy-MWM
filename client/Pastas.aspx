<%@ Page Title="" Language="C#" MasterPageFile="~/client/clientmaster.master" AutoEventWireup="true" CodeFile="Pastas.aspx.cs" Inherits="client_pasta" %>
...
<td id="Td3" runat="server" />
            ...
            <SelectedItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MDBConnectionString%>" SelectCommand="SELECT [id], [image], [name], [rate], [type] FROM [foods] where [Type]='Pastas'"></asp:SqlDataSource>
