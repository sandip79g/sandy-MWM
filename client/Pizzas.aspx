<%@ Page Title="" Language="C#" MasterPageFile="~/client/clientmaster.master" AutoEventWireup="true" CodeFile="Pizzas.aspx.cs" Inherits="client_pizzas" %>
				...
				<ul>
				    <li>
				    	...
				    	<div class="card-header">
				    		<asp:Label ID="Label1" runat="server" Text='<%# Eval("Name") %>' /></div>

                        <div class="card-title priding-card-title">
...
<td id="Td3" runat="server" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MDBConnectionString %>" SelectCommand="SELECT [id], [image], [name], [rate], [type] FROM [foods] where [Type]='Pizzas'"></asp:SqlDataSource>
