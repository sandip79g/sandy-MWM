<%@ Page Title="" Language="C#" MasterPageFile="~/client/clientmaster.master" AutoEventWireup="true" CodeFile="MoMo.aspx.cs" Inherits="client_momo" %>
...
<td id="Td3" runat="server" />
            ...
            <SelectedItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MDBConnectionString%>" SelectCommand="SELECT [id], [image], [name], [rate], [type] FROM [foods] where [Type]='MoMo'"></asp:SqlDataSource>
